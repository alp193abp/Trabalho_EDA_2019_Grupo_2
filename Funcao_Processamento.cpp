...
void map2doc(map<string,vector<int> > m){
	...
	//Cada linha È uma palavra junto com todos os ids de textos que aparece
...
int main (){
	...
	//Converte o dicion·rio de tÌtulos e o dicion·rio de ocorrencia de palavras pra documentos txt
	titulo2doc(titulos);
	map2doc(ocorrencia);
